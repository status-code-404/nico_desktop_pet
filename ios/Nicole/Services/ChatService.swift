...
actor ChatService {
    ...
    private func callLLM(_ message: String) async throws -> String {
        ...
        var req = URLRequest(url: URL(string: APIConfig.deepseekURL)!)
        req.httpMethod = "POST"
        req.setValue("application/json", forHTTPHeaderField: "Content-Type")
        req.setValue("Bearer \(APIConfig.deepseekKey)", forHTTPHeaderField: "Authorization")
